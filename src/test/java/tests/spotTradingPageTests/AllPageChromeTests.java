...
public class AllPageChromeTests extends BaseTest {
    ...
    public void tradeNavSpotTradingPage() throws IOException, InterruptedException {
        ...
        pixelPerfect.byElement("(//div[@class='menu-wrapper'])[1]",
                "Screenshots/Spot_Trading_page/EnChrome/Screenshots_tradeNavSpotTradingPage/real_life_screenshot.png",
                "Screenshots/Spot_Trading_page/EnChrome/Screenshots_tradeNavSpotTradingPage/mock_screenshot.png",
                "Screenshots/Spot_Trading_page/EnChrome/Screenshots_tradeNavSpotTradingPage/difference.png", "FULL HD");
