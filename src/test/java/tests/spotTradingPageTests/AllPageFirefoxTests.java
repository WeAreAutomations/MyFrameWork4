...
public class AllPageFirefoxTests extends BaseTest {
    ...
    public void allHeaderSpotTradingPage() throws IOException, InterruptedException {
        ...
        pixelPerfect.byElement("//div[@class='header-wrapper']",
                ...
                "Screenshots/Spot_Trading_page/EnFirefox/Screenshots_allHeaderSpotTradingPage/difference.png", "FULL HD");
    ...
    public void tradeNavSpotTradingPage() throws IOException, InterruptedException {
        ...
        pixelPerfect.byElement("(//div[@class='menu-wrapper'])[1]",
                ...
                "Screenshots/Spot_Trading_page/EnFirefox/Screenshots_tradeNavSpotTradingPage/difference.png", "FULL HD");
    ...
    public void productsNavSpotTradingPage() throws IOException, InterruptedException {
        ...
        pixelPerfect.byElement("(//div[@class='menu-wrapper'])[2]",
                ...
                "Screenshots/DSpot_Trading_page/EnFirefox/Screenshots_productsNavSpotTradingPage/difference.png", "FULL HD");
...
//        action.ifButtonIsPresentClick("//button[@class='close-button']");
        ...
        pixelPerfect.byElement("(//div[@class='menu-wrapper'])[3]",
                ...
                "Screenshots/Spot_Trading_page/EnFirefox/Screenshots_companyNavSpotTradingPage/difference.png", "FULL HD");
    ...
    public void profileNavSpotTradingPage() throws IOException, InterruptedException {
        ...
        pixelPerfect.byElement("(//div[@class='menu-wrapper'])[4]",
                ...
                "Screenshots/Spot_Trading_page/EnFirefox/Screenshots_profileNavSpotTradingPage/difference.png", "FULL HD");
